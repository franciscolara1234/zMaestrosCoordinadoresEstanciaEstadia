...
<head>
    ...
    <script>
        function confirmacion(){
            var respuesta=confirm('¿DESEA INGRESAR LAS OBSERVACIONES?');
            if(respuesta == true){
                return true;
...
<body>
    ...
    <main class="main-container">
        ...
        {{-- method="post" target="_blank" --}}
            <form action="/mensajeCoordinadorCarrera/" class="buscador-matricula">
       ...
       {{-- seccion de informacion general --}}
        ...
        <section class="contenedor-observaciones">
            ...
            {{-- method="post" target="_blank" --}}
             <form action="{{ route('mensajeCoordinadorCarrera.index')}}" class="contenedor-observaciones-generales">
                ...
                <div class="observaciones-coordinador">
                    ...
                    <textarea class="mensaje-observaciones-coordinador" name="observaciones-coordinador-carrera" placeholder="observaciones" minlength="20" maxlength="1000" required></textarea>
                </div>


                <input type="submit"  value="aprobar cedula" class="boton-aprobar-cedula"  onclick="return confirmacion()" disabled>

                <input type="submit"  value="guardar observaciones" class="boton-rechazar-cedula" onclick="return confirmacion()" >

                {{-- <a  class="boton-rechazar-cedula" href="{{ route('mensajeCoordinadorCarrera.index')}}" onclick="return confirmacion()" >
                    <div >
