...
class UsuariosController extends Controller
{
    ...
    public function ver()
    {
        ...
        $carreras = Orm_carrera::get();
        $gradoAcademico = Orm_grado_academico::get();
        return view('admin.agregar_usuario', ['tipousuario' => $tiposUsuarios])->with(['carreras' => $carreras])->with(['gradoAcademico' => $gradoAcademico]);
    }
